...
from evaluation.CLEAR_MOD_HUN_mAP import CLEAR_MOD_HUN_mAP



def modMetricsCalculator_mAP(res_fpath, gt_fpath):
    """
    ...
    for t in frames:
        ...
        frame_ctr += 1
    recall, precision, MODA, MODP,map_value = CLEAR_MOD_HUN_mAP(gtAllMatrix, detAllMatrix, [0.5,0.8])
...
if __name__ == "__main__":
    ...
    tSource = os.path.join(general_path,'moda_pred.txt')
    gtSource = os.path.join(general_path,'moda_gt.txt')
    recall, precision, MODA, MODP = modMetricsCalculator(tSource, gtSource)
    print(recall, precision, MODA, MODP)

    recall, precision, MODA, MODP,map_value= modMetricsCalculator_mAP(tSource, gtSource)
    print(recall, precision, MODA, MODP, map_value)