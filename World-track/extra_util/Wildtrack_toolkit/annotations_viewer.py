...
def parse_args():
    ...
    parser.add_argument('--dir_annotations', default='/media/rasho/Data 1/Arbeit/dataset/wildtrack/annotations_positions',
                        help='directory where the annotations are stored, default: %(default)s')
    parser.add_argument('--dir_frames', default='/media/rasho/Data 1/Arbeit/dataset/wildtrack/Image_subsets',
                        help='root directory which contains the frames in separate subdirectories per view, '
                             'default: %(default)s', )
    parser.add_argument('--ann_ext', default='.json',
                        help='extension of the annotations, default: %(default)s')
